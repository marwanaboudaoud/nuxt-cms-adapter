<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 my-10 rounded-xl">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">{{ section.subtitle }}</h2>
          <p class="mt-6 text-lg leading-8 text-gray-300">{{ section.description }}</p>
        </div>
        <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            <div v-for="stat in section.stats" :key="stat.name" class="flex flex-col-reverse">
